Title:			README_BiomassInsect2.0
Project:		LANDIS-II Landscape Change Model
Project Component:	Extension-Base-Harvest
Component Deposition:	https://github.com/LANDIS-II-Foundation/Extension-Biomass-Insect
Author:			LANDIS-II Foundation
Origin Date:		22 Apr 2017
Final Date:		22 Apr 2017


Welcome to the source code repository for Extension-Base-Harvest, a LANDIS-II disturbance extension.

Extension-Biomass-Insect models key aspects of insect-generated, defoliation outbreak dynamics including; 
disturbance initiation, within-patch variability in intensity and host/non-host response, among-patch 
disturbance spread and host/non-host response, and disturbance crashes and gradual recovery of surviving 
hosts. Extension-Biomass-Insect (a) stochastically introduces periodic defoliation events parameterized 
uniquely by defoliator species to capture realistic spatial and temporal patterns, and (b) modifies tree 
growth and mortality (ANPP) with species-specific response relationships. In addition the extension has the 
ability to simulate multiple defoliators in the same landscape.

Extension-Biomass-Insect models landscape-level effects on forest growth and mortality that result from 
outbreak defoliation events with annual time steps. It incorporates empirical information from 
satellite-derived maps to capture realistic spatial and temporal patterns of defoliation intensity. 
Key differences from an earlier LANDIS-II extension for a Biological Disturbance Agent (BDA) include 
making it functional for annual time steps, partial disturbance, and integrating it with the biomass 
