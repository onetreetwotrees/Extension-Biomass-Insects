...
namespace Landis.Extension.Insects
{
        ...
        : ExtensionMain
    {
        ...
        public static List<IInsect> insects;
        ...
        public override void Initialize()
        {
            ...
            mapNames = parameters.MapNamesTemplate;
            manyInsect = parameters.ManyInsect;
            insects = parameters.ManyInsect;
            ...
            MetadataHandler.InitializeMetadata(parameters.Timestep, parameters.LogFileName);
            ...
            foreach(IInsect insect in manyInsect)
            {
                ...
                if ((insect.ActiveOutbreak && insect.OutbreakStartYear < PlugIn.ModelCore.CurrentTime) || (meanDefoliation > 0) || (insect.LastBioRemoved > 0))
                {
                    if (insect.ActiveOutbreak)
                    {
                        ...
                        el.NumSites0_33 = numSites0_33;
                        el.NumSites33_66 = numSites33_66;
                        el.NumSites66_100 = numSites66_100;
                        el.InitialSites = insect.InitialSites;
                        el.LastBiomassRemoved = insect.LastBioRemoved;
