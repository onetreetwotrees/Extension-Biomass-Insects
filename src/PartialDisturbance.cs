        ...
        : IDisturbance
    {
        ...
        int IDisturbance.ReduceOrKillMarkedCohort(ICohort cohort)
        {
            ...
            foreach (IInsect insect in PlugIn.ManyInsect)
            {
                ...
                //PlugIn.ModelCore.UI.WriteLine(" {0}  insectIndex={1}, activeInsectIndex={2}, thisInsectIndex={3}.", thisInsect, insectIndex, PlugIn.activeInsectIndex,thisInsectIndex);
                ...
                if (insect.AnnMort == "7Year")
                {
                    ...
                    if (cumulativeDefoliation >= 0.50 && activeInsectCurrentDefoliation > 0.01)
                    {
